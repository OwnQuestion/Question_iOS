...
//                [Utility showAlertWithMessage:@"没有相机访问权限，请在\"设置\"--\"隐私\"--\"相机\"--\"考拉社区\"中设置"];
        ...
        if (error)
        {
            ...
            if(error.code==-11852)
            {
                UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"提示" message:@"没有相机访问权限，请在\"设置\"--\"隐私\"--\"麦克风\"--\"考拉社区\"中设置" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
                [alert show];
                [alert release];
            }
