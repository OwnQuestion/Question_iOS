...
// ********     初始化 view     *******
    ...
    [backBtn setImage:[[UIImage imageNamed:@"camera_back_defult.png"] stretchableImageWithLeftCapWidth:13 topCapHeight:0] forState:UIControlStateNormal];
    [backBtn setImage:[[UIImage imageNamed:@"camera_back_highlight.png"] stretchableImageWithLeftCapWidth:13 topCapHeight:0] forState:UIControlStateHighlighted];
    ...
    [backToCameraBtn setImage:[[UIImage imageNamed:@"album_back_default.png"] stretchableImageWithLeftCapWidth:13 topCapHeight:0] forState:UIControlStateNormal];
    [backToCameraBtn setImage:[[UIImage imageNamed:@"album_back_highlight.png"] stretchableImageWithLeftCapWidth:13 topCapHeight:0] forState:UIControlStateHighlighted];
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        {
            _positionBtn = button;
            [button setImage:[UIImage imageNamed:@"camera_toggle_default.png"] forState:UIControlStateNormal];
            [button setImage:[UIImage imageNamed:@"camera_toggle_highlight.png"] forState:UIControlStateHighlighted];
        ...
        else if (i == 2)
        {
            ...
            switch ([camManager getFlashMode])
            {
                ...
                {
                    [button setImage:[UIImage imageNamed:@"camera_flashClose_default.png"] forState:UIControlStateNormal];
                    break;
                }
                case AVCaptureFlashModeAuto:
                {
                    [button setImage:[UIImage imageNamed:@"camera_flashAuto_highlight.png"] forState:UIControlStateNormal];
                    break;
                }
                case AVCaptureFlashModeOn:
                {
                    [button setImage:[UIImage imageNamed:@"camera_flashOpen_highlight.png.png"] forState:UIControlStateNormal];
                    break;
                }
                default:
                    break;
        ...
        {
            _gridBtn = button;
            [button setImage:[UIImage imageNamed:@"camera_grid_default.png"] forState:UIControlStateNormal];
            button.showsTouchWhenHighlighted = YES;
    ...
    [albumBtn setImage:[UIImage imageNamed:@"albumButton.png"] forState:UIControlStateNormal];
    ...
    */
    ...
    [photoBtn setImage:[UIImage imageNamed:@"takeCamera_default.png"] forState:UIControlStateNormal];
    [photoBtn setImage:[UIImage imageNamed:@"takeCamera_highlight.png"] forState:UIControlStateHighlighted];
...
//        _gridView.alpha = 0.0f;
    ...
    [UIView animateWithDuration:0.3f animations:^{
        ...
        if (_gridView.hidden)
        {
            [sender setImage:[UIImage imageNamed:@"camera_grid_default.png"] forState:UIControlStateNormal];
        }
        else
        {
            [sender setImage:[UIImage imageNamed:@"camera_grid_highlight.png"] forState:UIControlStateNormal];
        }
...
- (void)hideGrid
{
    if (_gridView != nil)
    {
        [_gridBtn setImage:[UIImage imageNamed:@"camera_grid_default.png"] forState:UIControlStateNormal];
        [UIView animateWithDuration:0.3f animations:^{
//            _gridView.alpha = 0.0f;
            _gridView.hidden = YES;
        }];
...
- (void)toggleFlashMode:(id)sender
{
    switch ([camManager getFlashMode]) {
        case AVCaptureFlashModeOn:
        {
            ...
            [_flashBtn setImage:[UIImage imageNamed:@"camera_flashAuto_highlight.png"] forState:UIControlStateNormal];
            break;
        }
        case AVCaptureFlashModeAuto:
        {
            [camManager setFlashMode:AVCaptureFlashModeOff];
            [_flashBtn setImage:[UIImage imageNamed:@"camera_flashClose_default.png"] forState:UIControlStateNormal];
            break;
        }
        case AVCaptureFlashModeOff:
        {
            [camManager setFlashMode:AVCaptureFlashModeOn];
            [_flashBtn setImage:[UIImage imageNamed:@"camera_flashOpen_highlight.png"] forState:UIControlStateNormal];
            break;
        }
